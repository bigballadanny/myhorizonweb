      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 py-16">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 mb-12">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-white/30 text-xs font-medium uppercase tracking-widest mb-2">Pages</p>
            {navLinks.map((link) => (
              <button
                key={link.id}
          ...
          {/* Social */}
          <div className="flex flex-col gap-3">
            <p className="text-white/30 text-xs font-medium uppercase tracking-widest mb-2">Follow</p>
            <div className="flex items-center gap-5">
              <a href="https://x.com/SynthiosAI" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.tiktok.com/@myhorizon.ai" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.instagram.com/myhorizon.ai" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://linkedin.com/company/myhorizon" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/40">© 2026 MyHorizon. All rights reserved.</p>
          <p className="text-sm text-white/40">AI Systems & Automation</p>
        </div>
