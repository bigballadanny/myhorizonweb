      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real results from businesses running on our AI infrastructure. These aren't projections—they're actual outcomes.
          </p>
        </motion.div>

        {/* Metrics Grid - Larger cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {metrics.map((metric, index) => {
            ...
            return (
              ...
              >
                <div className="bg-card clean-border rounded-2xl p-10 text-center hover:elevated-shadow transition-all duration-300 hover:-translate-y-1">
                  {/* Icon */}
