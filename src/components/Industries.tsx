...
const industries: Industry[] = [
  ...
  },
  {
    ...
    accentColor: 'hover:border-l-4 hover:border-l-indigo-500',
    accentIconBg: 'group-hover:bg-indigo-50 group-hover:border-indigo-200 dark:group-hover:bg-indigo-950/30 dark:group-hover:border-indigo-800',
    accentText: '#6366f1',
  },
  {
    slug: 'underwriters',
